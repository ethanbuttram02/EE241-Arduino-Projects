...
#define MD_PIN 9        //Metal detect signal pin
...
void loop() {
  ...
  if (period >= 79 and period <= 90 and tStart > 200) {         // The range of acceptable values found from testing that will be shown when the metal detector has detected a metal object
